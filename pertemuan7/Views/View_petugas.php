...
<table border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="../Views/View_put_petugas.php?id_petugas=<?php echo base64_encode($Get['id_petugas']) ?>"><img src="view.png" style="width: 20px; height: 20px;"></a>
                    <button onclick="konfirmasi(<?php echo $Get['id_petugas'] ?>)"><img src="sampah.png" style="width: 20px; height: 20px;"></button>
                </td>
            </tr>
    <?php
        }
