...
<table border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="../Views/View_put_siswa.php?nisn=<?php echo base64_encode($Get['nisn']) ?>"><img src="view.png" style="width: 20px; height: 20px;"></a>
                    <button onclick=" konfirmasi(<?php echo $Get['nisn'] ?>)"><img src="sampah.png" style="width: 20px; height: 20px;"></button>
            </tr>
    <?php
        }
    }
