...
<table border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="../Views/View_put_spp.php?id_spp=<?php echo base64_encode($Get['id_spp']) ?>"><img src="view.png" style="width: 20px; height: 20px;"></a>
                    <button onclick="konfirmasi(<?php echo $Get['id_spp'] ?>)"><img src="sampah.png" style="width: 20px; height: 20px;"></button>
                </td>
            </tr>
    <?php
        }
